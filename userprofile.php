...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">userprofile</strong></div>
        </div>
      </div>
    </div>
          ...
          <form class="col-md-12" method="post">
            <div class="site-blocks-table">
              <table class="table table-bordered">
                <thead>
                    <h1 class="text-center mb-5 text-dark">Your Previous Order</h1>
                  <tr>
            ...
            if(isset($_SESSION['id']))    {
              $id = $_SESSION['id'];
$q = "select product.pname,product.pimage,product.pprice,uorder.qty,uorder.pname,uorder.total from product inner join uorder on  uorder.pname=product.pname where cid =$id;";
// $q = "select product.pname,product.pimage,uord";
...
<td ><span id='qty_price' class="h4"><?=$data['pprice']?></span></td>
<td>
