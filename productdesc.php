       ...
       <div class="row">
        <div class="col-12 d-flex justify-content-center">
            ...
            while($data = mysqli_fetch_assoc($result)){
              ...
              <img src="pimages/<?=$data['pimage']?>" height="800px" width="800px" alt="">
              <div class="container">
                <h3 class="text-dark"><?=$data['pname']?></h3>
                <hr class="divider-liner bg-dark">
                <h5 class="text-dark">$<?=$data['pprice']?></h5>
                <h5 class="text-dark">Size:</h5>
                <h5  class="text-dark">Gender: <span><?=$data['pcategory']?></span></h5>
                
                <hr class="divider-liner bg-dark">

                <button class="btn btn-warning col-12 mt-5 " onclick="upt_cart('<?=$data['id']?>','<?=$data['pprice']?>')"><a href="#" style="text-decoration: none;color: black;">Add To Cart</a></button>
                <h5 class="text-dark ml-3 mt-3">Product Description:</h5>
                <p name="" id="" class="col-9 mt-3 text-dark"><strong><?=$data['pdesc']?></strong></p>
