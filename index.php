...
<html lang="en">
  ...
  <body>
  <?php
if(isset($_SESSION['id'])==null && isset($_SESSION['role'])==null){
?>
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                ...
                <?php
                  ...
                  <li><span style="text-decoration: none;" class="mr-2 text-dark mb-2" id="uname"></span></li>
<?php
                }
    ...
    <div class="site-blocks-cover" style="background-image: url(images/banner1.jfif);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2 text-light">Finding Your Perfect Shoes</h1>
            <div class="intro-text text-center text-md-left">
              <p class="mb-4 text-light"><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus at iaculis quam. Integer accumsan tincidunt fringilla. </strong></p>
              <p>
                <a href="#" class="btn btn-sm btn-warning ml-5">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="category.php?cat=women">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="category.php?cat=children">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <a class="block-2-item" href="category.php?cat=Men">
              <figure class="image">
...
<img class="card-img-top" src="pimages/<?=$data['pimage']?>" width="2700px" height="400px"  alt="Card image cap">
  <div class="card-body" style="height: 180px;">
    <h5 class="card-title text-info mt-3 text-center" style="height: 60px;"><?=$data['pname']?></h5>
      ...
      <div class="container">
        <div class="row justify-content-center  mb-5">
          <div class="col-md-7 site-section-heading text-center pt-4">
            <h2 class="text-info">Big Sale!</h2>
          </div>
        </div>
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p><a href="#" class="btn btn-warning btn-sm">Shop Now</a></p>
          </div>
        </div>
      </div>
    </div>
