...
session_start();
if(isset($_SESSION)){
if($_SESSION['id']=='' || $_SESSION['role']=='user'){
    
echo "<script>alert('Login with Admin Credentials!')
</script>";
...
<h5 class="text-white ml-2">Manage Products</h5>
<h6><a href="addcat.php" class="text-white ml-2">Add Category</a></h6>
<h6><a href="addproduct.php" class="text-white ml-2">Add Product</a></h6>
<div class="pcoded-navigation-label ">Orders</div>
<h6 class="text-white "><a href="neworders.php" class="text-white ml-2">New Orders</a></h6>
<h6><a href="addcat.php" class="text-white ml-2">Orders Completed</a></h6>
...
<div class="pcoded-content col-12">
